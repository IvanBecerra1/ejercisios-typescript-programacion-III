...
if (isset($_POST['accion']) && $_POST['accion'] == 'agregar') {
    echo "<h1>Agregando Alumno PDO</h1> <br>";

    $foto = "./fotos/" . $_FILES["foto"]["name"];
    echo "datos: $nombre, $apellido , $legajo";

    //Alumno::guardar(new Alumno($nombre, $apellido, $legajo, $foto));
    $guardarAlumno = new Alumno($nombre, $apellido, $legajo, $foto);

    var_dump($guardarAlumno);
    $guardarAlumno->guardarPDO();
    ...
    $foto = "./fotos/" . $_FILES["foto"]["name"];
    //Alumno::editar(new Alumno($nombre, $apellido, $legajo,  $foto));

    Alumno::modificarPDO(new Alumno($nombre, $apellido, $legajo,  $foto));
   ...
   // Alumno::eliminar(new Alumno("","" , $legajo, ""));
    Alumno::eliminarPDO(new Alumno("","" , $legajo, ""));

} elseif (isset($_POST['accion']) && $_POST['accion'] == 'verificar') {
    
    echo "<h1>Verificando alumno </h1><br>";
